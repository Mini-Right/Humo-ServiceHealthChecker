...
from SHC.plugins.table_converter import (orm_fields_all_to_list, orm_fields_one_to_dict, orm_table_all_to_list,
...
class HumoTableRead(CURDTableBase):
    ...
    def query_sql_list(
            self, sql: any, is_list: bool = False, is_lower: bool = False
    ):
        with self.session() as session:
            try:
